...
import android.app.printerapp.devices.control.ControlPanal;
...
public class GcodeFile  {
	...
	private static ProgressDialogPro prepareProgressDialog(Context context) {
        ...
        dialog.setTitle(R.string.charg_gcode);
	...
	public static void processGcode(StringBuilder allLines, int maxLines) {
        ...
        int[] auxPlate = {DeltaFaces.DELTA_LONG, DeltaFaces.DELTA_WITDH, DeltaFaces.DELTA_HEIGHT};
