...
public class StlFile {
    ...
    private static ProgressDialogPro prepareProgressDialog(Context context) {
        ...
        dialog.setTitle(R.string.charg_stl);
    ...
    private static Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (mData.getCoordinateListSize() < 1) {
                Toast.makeText(mContext, R.string.invalide_file, Toast.LENGTH_SHORT).show();
                ViewerMainFragment.resetWhenCancel();
    ...
    public static boolean saveModel(List<DataStorage> dataList, String projectName, Slicer slicer) {
